...
--
-- Host: 127.0.0.1    Database: campaniacovidfree
-- ------------------------------------------------------
...
--
-- Current Database: `campaniacovidfree`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `campaniacovidfree` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `campaniacovidfree`;

--
-- Table structure for table `asl`
--
...
--
-- Dumping data for table `asl`
--

LOCK TABLES `asl` WRITE;
/*!40000 ALTER TABLE `asl` DISABLE KEYS */;
INSERT INTO `asl` VALUES ('ASL AVELLINO','Via degli imbimbo'),('ASL BENEVENTO','Via Oderisio'),('ASL CASERTA','Via unità italiana'),('ASL NAPOLI 1 CENTRO','Via comunale del principe'),('ASL NAPOLI 2 NORD','Via corrado alvaro'),('ASL NAPOLI 3 SUD','Corso alcide de gasperi'),('ASL SALERNO','Via nizza'),('ASL1','Centro');
/*!40000 ALTER TABLE `asl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dipendentiasl`
--

DROP TABLE IF EXISTS `dipendentiasl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dipendentiasl` (
  ...
  KEY `FK9mxxkw11psap3l2s1bxvyq5l` (`asl`),
  CONSTRAINT `FK9mxxkw11psap3l2s1bxvyq5l` FOREIGN KEY (`asl`) REFERENCES `asl` (`nome_centro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dipendentiasl`
--

LOCK TABLES `dipendentiasl` WRITE;
/*!40000 ALTER TABLE `dipendentiasl` DISABLE KEYS */;
INSERT INTO `dipendentiasl` VALUES ('cirobuono@gmail.com','Buono','M00','Ciro','0000','ASL SALERNO'),('francorossi@gmail.com','Rossi','M99','Franco','1111','ASL AVELLINO'),('giu@hotmail.it','Pip','M63','Giuseppe','1234','ASL NAPOLI 1 CENTRO'),('marioesposito@gmail.com','Esposito','M43','Mario','2323','ASL NAPOLI 3 SUD'),('martinapatierno@libero.it','Patierno','M59','Martina','9069','ASL BENEVENTO'),('pasqualeesposito@gmail.com','Esposito','M22','Pasquale','2222','ASL NAPOLI 2 NORD'),('salvatoredinapoli@hotmail.it','Di Napoli','M60','Salvatore','1456','ASL CASERTA');
/*!40000 ALTER TABLE `dipendentiasl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `medicidibase`
--

DROP TABLE IF EXISTS `medicidibase`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `medicidibase` (
  ...
  `asl` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`email`),
  KEY `FKfswhb22mmetihw3p5btq2aq79` (`asl`),
  CONSTRAINT `FKfswhb22mmetihw3p5btq2aq79` FOREIGN KEY (`asl`) REFERENCES `asl` (`nome_centro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `medicidibase`
--

LOCK TABLES `medicidibase` WRITE;
/*!40000 ALTER TABLE `medicidibase` DISABLE KEYS */;
INSERT INTO `medicidibase` VALUES ('giovannimenafra@hotmail.it','Menafra','via cilea','Giovanni','1213','ASL CASERTA'),('leoiollo@gmail.com','Iollo','via Soldoni','Leonardo','6699','ASL NAPOLI 3 SUD'),('margheritaimparato@hotmail.it','Imparato','via de gasperi','Margherita','1232','ASL AVELLINO'),('pasqualebianco@libero.it','Bianco','via dei vivi','Pasquale','9987','ASL BENEVENTO'),('porfi@hotmail.it','Tramontana','via claudio','Porfirio','1111','ASL NAPOLI 1 CENTRO'),('simonedanisi@hotmail.it','Danisi','Via pelosi','Simone','3998','ASL SALERNO');
/*!40000 ALTER TABLE `medicidibase` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pazienti` (
  ...
  PRIMARY KEY (`email`),
  KEY `FKf0ubgfgb2e6mfhgi9uxuc2cf1` (`medico`),
  KEY `FKpciw91emlnocvvi8mwialbml6` (`asl`),
  CONSTRAINT `FKf0ubgfgb2e6mfhgi9uxuc2cf1` FOREIGN KEY (`medico`) REFERENCES `medicidibase` (`email`) ON UPDATE CASCADE,
  CONSTRAINT `FKpciw91emlnocvvi8mwialbml6` FOREIGN KEY (`asl`) REFERENCES `asl` (`nome_centro`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pazienti` VALUES ('albertobianco@libero.it','Bianco',1,'via Bologna','Alberto','1100','ASL BENEVENTO','pasqualebianco@libero.it',1,'positivo'),('andreadarco@hotmail.it','DArco',1,'vincenzo Janfolla','Andrea','1234','ASL NAPOLI 1 CENTRO','porfi@hotmail.it',2,'transizione'),('giuseppe.pipicelli96@gmail.com','Pipicelli',1,'via cavallino','Giuseppe','5678','ASL NAPOLI 1 CENTRO','porfi@hotmail.it',2,'negativo'),('nicolacalamita@gmail.com','Calamita',1,'Via Fontana','Nicola','3030','ASL NAPOLI 3 SUD','leoiollo@gmail.com',3,'transizione'),('robertodarco@hotmail.it','DArco',1,'vincenzo Janfolla','Roberto','1508','ASL SALERNO','simonedanisi@hotmail.it',4,'positivo'),('salvatoreesposito@gmail.com','Esposito',0,'via nazionale','Salvatore','1010','ASL CASERTA','giovannimenafra@hotmail.it',5,'negativo'),('siliamena@hotmail.it','Menafra',1,'due portoni','Silia','0202','ASL AVELLINO','margheritaimparato@hotmail.it',6,'negativo');
/*!40000 ALTER TABLE `pazienti` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `resoconti_giornalieri`
--

DROP TABLE IF EXISTS `resoconti_giornalieri`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `resoconti_giornalieri` (
  `data` date NOT NULL,
  `tamponi_effettuati` int DEFAULT NULL,
  `tamponi_positivi` int DEFAULT NULL,
  PRIMARY KEY (`data`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `resoconti_giornalieri`
--

LOCK TABLES `resoconti_giornalieri` WRITE;
/*!40000 ALTER TABLE `resoconti_giornalieri` DISABLE KEYS */;
/*!40000 ALTER TABLE `resoconti_giornalieri` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `risultati_tampone`
--

DROP TABLE IF EXISTS `risultati_tampone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `risultati_tampone` (
  `data_inserimento` date DEFAULT NULL,
  `esito` varchar(255) DEFAULT NULL,
  `dipendente_asl` varchar(255) DEFAULT NULL,
  `tampone` int DEFAULT NULL,
  `id_risultato` int NOT NULL,
  PRIMARY KEY (`id_risultato`),
  UNIQUE KEY `id_risultato_UNIQUE` (`id_risultato`),
  UNIQUE KEY `tampone_UNIQUE` (`tampone`),
  KEY `FK5e3inwina0oigxs08rrfpfhrv` (`dipendente_asl`) /*!80000 INVISIBLE */,
  KEY `FK5i6ranspirc8q8vlyvgmlnjhl` (`tampone`),
  CONSTRAINT `FK5e3inwina0oigxs08rrfpfhrv` FOREIGN KEY (`dipendente_asl`) REFERENCES `dipendentiasl` (`email`) ON UPDATE CASCADE,
  CONSTRAINT `FK5i6ranspirc8q8vlyvgmlnjhl` FOREIGN KEY (`tampone`) REFERENCES `tamponi` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `risultati_tampone`
--

LOCK TABLES `risultati_tampone` WRITE;
/*!40000 ALTER TABLE `risultati_tampone` DISABLE KEYS */;
INSERT INTO `risultati_tampone` VALUES ('2020-10-14','negativo','giu@hotmail.it',1,1),('2020-10-06','positivo','martinapatierno@libero.it',2,2),('2020-10-11','positivo','cirobuono@gmail.com',3,3),('2020-09-29','positivo','marioesposito@gmail.com',4,4),('2020-10-25','negativo','marioesposito@gmail.com',5,5),('2020-10-22','positivo','giu@hotmail.it',6,6),('2020-11-15','positivo','giu@hotmail.it',7,7),('2020-11-03','negativo','giu@hotmail.it',8,8),('2020-11-07','negativo','giu@hotmail.it',9,9);
/*!40000 ALTER TABLE `risultati_tampone` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sintomi` (
  ...
  `data_inserimento` date DEFAULT NULL,
  `intensita` varchar(255) DEFAULT NULL,
  `paziente` varchar(255) NOT NULL,
  PRIMARY KEY (`nome`,`paziente`),
  KEY `FKpel78kgw7a6qptnijrlxw3ji5` (`paziente`),
  CONSTRAINT `FKpel78kgw7a6qptnijrlxw3ji5` FOREIGN KEY (`paziente`) REFERENCES `pazienti` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tamponi`
--
...
CREATE TABLE `tamponi` (
  ...
  UNIQUE KEY `risultato_UNIQUE` (`risultato`) /*!80000 INVISIBLE */,
  KEY `FK2sec1gfbeakdlccp9b78bjar4` (`asl`) /*!80000 INVISIBLE */,
  KEY `FKjxvsvoekpwa2u4fsfhy9edopk` (`paziente`),
  KEY `FKhn91uilh08pa58re696pi7qv` (`risultato`),
  CONSTRAINT `FK2sec1gfbeakdlccp9b78bjar4` FOREIGN KEY (`asl`) REFERENCES `asl` (`nome_centro`),
  CONSTRAINT `FKhn91uilh08pa58re696pi7qv` FOREIGN KEY (`risultato`) REFERENCES `risultati_tampone` (`id_risultato`) ON DELETE SET NULL ON UPDATE RESTRICT,
  CONSTRAINT `FKjxvsvoekpwa2u4fsfhy9edopk` FOREIGN KEY (`paziente`) REFERENCES `pazienti` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tamponi`
--

LOCK TABLES `tamponi` WRITE;
/*!40000 ALTER TABLE `tamponi` DISABLE KEYS */;
INSERT INTO `tamponi` VALUES (1,'2020-10-12','andreadarco@hotmail.it','ASL NAPOLI 1 CENTRO',1),(2,'2020-10-04','albertobianco@libero.it','ASL BENEVENTO',2),(3,'2020-10-09','robertodarco@hotmail.it','ASL SALERNO',3),(4,'2020-09-27','nicolacalamita@gmail.com','ASL NAPOLI 3 SUD',4),(5,'2020-10-11','nicolacalamita@gmail.com','ASL NAPOLI 3 SUD',5),(6,'2020-10-20','giuseppe.pipicelli96@gmail.com','ASL NAPOLI 1 CENTRO',6),(7,'2020-11-21','andreadarco@hotmail.it','ASL NAPOLI 1 CENTRO',7),(8,'2020-11-01','giuseppe.pipicelli96@gmail.com','ASL NAPOLI 1 CENTRO',8),(9,'2020-11-05','giuseppe.pipicelli96@gmail.com','ASL NAPOLI 1 CENTRO',9),(10,'2020-10-25','siliamena@hotmail.it','ASL AVELLINO',NULL),(11,'2020-11-24','andreadarco@hotmail.it','ASL NAPOLI 1 CENTRO',NULL),(12,'2020-11-20','giuseppe.pipicelli96@gmail.com','ASL NAPOLI 1 CENTRO',NULL);
/*!40000 ALTER TABLE `tamponi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'campaniacovidfree'
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-10-12 10:22:14',NULL),('diagnostics.include_raw','OFF','2020-10-12 10:22:14',NULL),('ps_thread_trx_info.max_length','65535','2020-10-12 10:22:14',NULL),('statement_performance_analyzer.limit','100','2020-10-12 10:22:14',NULL),('statement_performance_analyzer.view',NULL,'2020-10-12 10:22:14',NULL),('statement_truncate_len','64','2020-10-12 10:22:14',NULL);
...
-- Dump completed on 2020-10-25 12:57:34
